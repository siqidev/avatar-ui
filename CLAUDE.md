...
1. docs/PROJECT.md — プロジェクトの本質・概念設計・戦略・Decision Log（バージョン非依存）
...
- 概念設計（場モデル6要素・不変条件・設計責務）→ docs/PROJECT.md
- 用語定義 → docs/PROJECT.md
...
| プロジェクト方針の変更 | docs/PROJECT.md を同一コミットで更新 |
